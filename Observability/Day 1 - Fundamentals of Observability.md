...
- Observability is the ability to understand the internal state of a system by analysing the data it produces, including logs, metrics, and traces.
...
![](../Attachments/Pasted%20image%2020241009054819.png)
...
![](../Attachments/Pasted%20image%2020241009054838.png)
...
- Security: Unauthorised access attempts, vulnerability scans, firewall logs.
